...
import com.hidil.fypsmartfoodbank.ui.fragments.admin.FoodBankInfoAdminFragmentDirections
        ...
        if (model.itemQuantity > 0) {
            ...
            holder.binding.ivItemImage.setOnClickListener { view ->
                view.findNavController().navigate(
                    FoodBankInfoAdminFragmentDirections.actionFoodBankInfoAdminFragmentToStorageInfoAdminFragment(
                        model.id
                    )
                )
            }
